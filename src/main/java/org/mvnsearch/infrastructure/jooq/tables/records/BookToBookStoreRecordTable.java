...
public class BookToBookStoreRecordTable extends UpdatableRecordImpl<BookToBookStoreRecordTable> implements Record3<String, Integer, Integer> {

	private static final long serialVersionUID = -774553535;
	 ...
	 */
	@Override
	public BookToBookStoreRecordTable value1(String value) {
		setName(value);
		return this;
	}
	 ...
	 */
	@Override
	public BookToBookStoreRecordTable value2(Integer value) {
		setBookId(value);
		return this;
	}
	 ...
	 */
	@Override
	public BookToBookStoreRecordTable value3(Integer value) {
		setStock(value);
		return this;
	}
	 ...
	 */
	@Override
	public BookToBookStoreRecordTable values(String value1, Integer value2, Integer value3) {
		value1(value1);
		value2(value2);
		value3(value3);
		return this;
	...
	/**
	 * Create a detached BookToBookStoreRecordTable
	 */
	public BookToBookStoreRecordTable() {
		super(BookToBookStoreTable.BOOK_TO_BOOK_STORE);
	}

	/**
	 * Create a detached, initialised BookToBookStoreRecordTable
	 */
	public BookToBookStoreRecordTable(String name, Integer bookId, Integer stock) {
		super(BookToBookStoreTable.BOOK_TO_BOOK_STORE);
